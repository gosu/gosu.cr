...
describe Gosu::Color do
  ...
  it "test_color_creation" do
    ...
    Gosu::Color::YELLOW.should eq(Gosu::Color.from_ahsv(255_u8, 60, 1.0, 1.0))
  end
  ...
  it "test_color_attribute_ranges" do
    ...
    Gosu::Color.from_ahsv(100_u8, 1, 1.0, 1.0).should eq(Gosu::Color.from_ahsv(100_u8, 361, 1.0, 1.0))

    # saturation and value are clamped to 0.0..1.0 (since commit 01120e92f7a3).
    Gosu::Color.from_ahsv(100_u8, 1, 1.0, 1.0).should eq(Gosu::Color.from_ahsv(100_u8, 361, 2.0, 2.0))
    Gosu::Color.from_ahsv(100_u8, 1, 0.0, 0.0).should eq(Gosu::Color.from_ahsv(100_u8, 361, -1.0, -1.0))
  end
