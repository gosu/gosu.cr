...
module Gosu
  ...
  def self.button_char_to_id(char : String) : UInt32
  ...
  def self.offset_x(theta : Float64 | Int32, r : Float64 | In32) : Float64
    GosuC.offset_x(theta.to_f64, r.to_f64)
  end

  def self.offset_y(theta : Float64 | Int32, r : Float64 | In32) : Float64
    GosuC.offset_y(theta.to_f64, r.to_f64)
  end

  def self.distance(x1 : Float64 | Int32, y1 : Float64 | In32,
                    x2 : Float64 | Int32, y2 : Float64 | Int32) : Float64
    GosuC.distance(x1.to_f64, y1.to_f64, x2.to_f64, y2.to_f64)
  end

  def self.angle(x1 : Float64 | Int32, y1 : Float64 | In32,
                 x2 : Float64 | Int32, y2 : Float64 | Int32) : Float64
    GosuC.angle(x1.to_f64, y2.to_f64, x2.to_f64, y2.to_f64)
  end

  def self.angle_diff(angle1 : Float64 | Int32, angle2 : Float64 | In32) : Float64
